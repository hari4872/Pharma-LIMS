...
export default function LoginPage() {
  ...
  const features = [
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="none" width="18" height="18">
          <path d="M9 12l2 2 4-4M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke="#0d6e6e" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
    ...
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="none" width="18" height="18">
          <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" stroke="#0d6e6e" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
    ...
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="none" width="18" height="18">
          <path d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" stroke="#0d6e6e" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
  ...
  return (
    <div style={{
      ...
      <div style={{ position:'absolute', top:'-15%', right:'-8%', width:500, height:500, borderRadius:'50%', background:'rgba(255,255,255,0.08)', pointerEvents:'none' }} />
      <div style={{ position:'absolute', bottom:'-20%', left:'-10%', width:600, height:600, borderRadius:'50%', background:'rgba(255,255,255,0.06)', pointerEvents:'none' }} />
      <div style={{ position:'absolute', top:'30%', left:'35%', width:300, height:300, borderRadius:'50%', background:'rgba(255,255,255,0.04)', pointerEvents:'none' }} />
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }} className="lims-left-col">

          {/* Secure badge */}
          <div style={{
            display: 'inline-flex', alignItems: 'center', gap: 7,
            marginBottom: 28,
            fontSize: 11.5, fontWeight: 700, color: '#0d4a46',
          ...
          {/* Hero heading */}
          <h1 style={{ margin: '0 0 4px', fontSize: 56, fontWeight: 900, color: '#0a2e2b', letterSpacing: '-0.03em', lineHeight: 1.05 }}>
            LIMS
          </h1>
          <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom: 20 }}>
            <img src="/Logo.png" alt="Web Synergies" style={{ height: 32, width:'auto', objectFit:'contain' }} />
          </div>

          <p style={{ margin: '0 0 36px', fontSize: 15.5, color: '#0d4a46', lineHeight: 1.75, maxWidth: 460, opacity: 0.85 }}>
            A modern laboratory information management platform designed for
            regulated environments, rapid sample tracking, instrument visibility,
            and dependable quality workflows.
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {features.map((f, i) => (
              <div key={i} style={{
                ...
                <p style={{ margin: 0, fontSize: 13.5, color: '#0a3330', lineHeight: 1.65 }}>
                  {f.text}
                </p>
              </div>
            ))}
          ...
          <div style={{ marginTop: 28, fontSize: 11.5, color: 'rgba(10,46,43,0.55)', letterSpacing: '0.04em' }}>
        ...
        <div style={{
          ...
          background: '#ffffff',
          borderRadius: 24,
          boxShadow: '0 32px 80px rgba(10,46,43,0.18), 0 0 0 1px rgba(255,255,255,0.6)',
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, marginBottom: 24 }}>
            <div style={{
              ...
              background: 'linear-gradient(135deg, #0d6e6e 0%, #0a4f4f 100%)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              boxShadow: '0 4px 12px rgba(13,110,110,0.3)',
            }}>
              <img src="/Logo.png" alt="WS" style={{ width: 36, height: 36, objectFit: 'contain', filter: 'brightness(0) invert(1)' }} />
            </div>
            <div>
              <h2 style={{ margin: '0 0 4px', fontSize: 20, fontWeight: 700, color: '#0a2e2b', letterSpacing: '-0.015em' }}>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ position:'relative' }}>
                <span style={{ position:'absolute', left:12, top:'50%', transform:'translateY(-50%)', display:'flex', pointerEvents:'none', color:'#9ca3af' }}>
                ...
                <input id="lims-username" type="text"
                  style={{
          ...
          <div style={{ marginTop: 24, paddingTop: 20, borderTop:'1px solid #f1f5f9', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
            <span style={{ fontSize:11, color:'#94a3b8' }}>21 CFR Part 11 ready</span>
            <span style={{ fontSize:11, color:'#94a3b8' }}>ISO-aligned laboratory workflow</span>
      ...
      <style>{`
        ...
        @media (max-width: 860px) { .lims-left-col { display: none !important; } }
      `}</style>
    </div>
  )
}
