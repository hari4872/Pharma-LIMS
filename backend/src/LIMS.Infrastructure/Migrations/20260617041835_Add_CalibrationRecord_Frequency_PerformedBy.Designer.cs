...
namespace LIMS.Infrastructure.Migrations
{
    ...
    [Migration("20260617041835_Add_CalibrationRecord_Frequency_PerformedBy")]
    partial class Add_CalibrationRecord_Frequency_PerformedBy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.CapacityBooking", b =>
                {
                    b.Property<int>("CapacityBookingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CapacityBookingId"));
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.Coa", b =>
                {
                    ...
                    b.Property<string>("ConditionalJustification")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.FormTemplateParameter", b =>
                {
                    ...
                    b.Property<string>("ColumnFrequency")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.ProcessLogReading", b =>
                {
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.Sample", b =>
                {
                    ...
                    b.Property<int?>("RetestOfSampleId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.SampleContainer", b =>
                {
                    ...
                    b.HasIndex("ParentSampleContainerId");

                    b.HasIndex("SampleId");

                    b.HasIndex("StorageLocationId");

                    b.ToTable("sample_containers", (string)null);
                });

            modelBuilder.Entity("LIMS.Domain.Entities.SampleFormEntry", b =>
                {
                    b.Property<int>("SampleFormEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("SampleFormEntryId"));
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.SampleTypeCheckpoint", b =>
                {
                    b.Property<int>("SampleTypeCheckpointId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("SampleTypeCheckpointId"));
                    ...
                    b.HasKey("SampleTypeCheckpointId");

                    b.HasIndex("CheckpointId");

                    b.HasIndex("SampleTypeId", "CheckpointId")
                        .IsUnique();

                    b.ToTable("sample_type_checkpoints", (string)null);
                });
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.SpecificationTemplate", b =>
                {
                    ...
                    b.Property<string>("CompendialStandard")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.CapacityBooking", b =>
                {
                    b.HasOne("LIMS.Domain.Entities.User", "BookedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.ProcessLogReading", b =>
                {
                    ...
                    b.HasOne("LIMS.Domain.Entities.ProcessLogRow", "Row")
                        .WithMany("Readings")
                        .HasForeignKey("RowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.SampleContainer", b =>
                {
                    ...
                    b.HasOne("LIMS.Domain.Entities.SampleContainer", "ParentContainer")
                        ...
                        .HasForeignKey("ParentSampleContainerId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("LIMS.Domain.Entities.SampleType", b =>
                {
                    b.Navigation("DefaultCheckpoints");
                });
