...
public class DigitalLogbookController : LimsControllerBase
{
    ...
    // 21 CFR ยง11.10(e): original never deleted; amendment reason + e-sig mandatory
    [HttpPost("{id}/amend")]
    ...
    // GET api/v1/digital-logbook/export?format=csv — FR-09: export with all ยง11.50 manifestations
    [HttpGet("export")]
        ...
        [FromQuery] string format = "csv")
    {
        ...
        // Build CSV with all ยง11.50 audit columns
